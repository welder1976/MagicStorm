...
bool Guardian::InitStatsForLevel(uint8 petlevel)
{
    ...
    switch (petType)
    {
        ...
        default:
        {
            switch (GetEntry())
            {
                case ENTRY_WATER_ELEMENTAL_01: // Water Elemental
                case ENTRY_WATER_ELEMENTAL_02:
                {
                    SetBonusDamage(int32(GetOwner()->SpellBaseDamageBonusDone(SPELL_SCHOOL_MASK_MAGIC)));
                    break;
                }
                case ENTRY_TREANT: // Treant
                {
                ...
                case ENTRY_GREATER_EARTH_ELEMENTAL: // Greater Earth Elemental
                {
                    SetBaseWeaponDamage(BASE_ATTACK, MINDAMAGE, float(petlevel - (petlevel / 4)));
                    SetBaseWeaponDamage(BASE_ATTACK, MAXDAMAGE, float(petlevel + (petlevel / 4)));
                    break;
                }
                case ENTRY_GREATER_FIRE_ELEMENTAL: // Greater Fire Elemental
                {
                ...
                case ENTRY_SPIRIT_WOLF: // Spirit Wolf
                {
                ...
                case ENTRY_EBON_GARGOYLE: // Ebon Gargoyle
                {
                ...
                case ENTRY_BLOODWORM: // Bloodworm
                {
                ...
                case ENTRY_DREADSTALKER: // Dreadstalker
                {
                    SetBaseAttackTime(BASE_ATTACK, cinfo->BaseAttackTime);
