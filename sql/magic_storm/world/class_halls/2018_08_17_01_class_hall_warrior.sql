...
UPDATE `creature_template` SET `minlevel`=98, `maxlevel`=100, `VerifiedBuild`=26124 WHERE `entry`=96183;
...
(19875, 0, 0, 'Then Ill go with you.', 0),
(19874, 0, 0, 'What do you want to do?', 0);
...
REPLACE INTO `phase_area` (`AreaId`, `PhaseId`, `Comment`) VALUES (7502, 7301, 'PHASE 6764- CONDITION_QUESTSTATE'); 
...
('26', '7300', '7502', '0', '0', '47', '0', '41052', '10', '0', '0', '0', '0', '', 'phase 7300 on quest 41052 taken,complete'),
('26', '7300', '7502', '0', '0', '47', '0', '38904', '64', '0', '1', '0', '0', '', 'cancel phase 7300 on quest 38904 rewarded'); 

UPDATE `creature` SET `zoneId`=7505, `areaId`=7502, `PhaseId`=7300 WHERE `guid`=20556162;

REPLACE INTO `phase_area` (`AreaId`, `PhaseId`, `Comment`) VALUES (7502, 7301, 'PHASE 6764- CONDITION_QUESTSTATE'); 
REPLACE INTO conditions (SourceTypeOrReferenceId, SourceGroup, SourceEntry, SourceId, ElseGroup, ConditionTypeOrReference, ConditionTarget, ConditionValue1, ConditionValue2, ConditionValue3, NegativeCondition, ErrorType, ErrorTextId, ScriptName, Comment) VALUES 
('26', '7301', '7502', '0', '0', '47', '0', '42814', '10', '0', '0', '0', '0', '', 'phase 7301 on quest 42814 taken,complete'),
('26', '7301', '7502', '0', '0', '47', '0', '42815', '64', '0', '1', '0', '0', '', 'cancel phase 7301 on quest 42815 rewarded'); 

UPDATE `creature` SET `zoneId`=7505, `areaId`=7502, `PhaseId`=7301 WHERE `guid`=20556155;
