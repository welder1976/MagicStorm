...
INSERT INTO `creature_questender` (`id`, `quest`) VALUES (15297, 8338);
...
INSERT INTO `creature_queststarter` (`id`, `quest`) VALUES (16144, 9067);
...
INSERT INTO `gameobject_addon` (`guid`, `parent_rotation0`, `parent_rotation1`, `parent_rotation2`, `parent_rotation3`, `invisibilityType`, `invisibilityValue`, `WorldEffectID`) VALUES (43948, 0, 0, 0.0649414, 0.997889, 8, 1000, 0);
DELETE FROM `gameobject_addon` WHERE `guid`=49512;
INSERT INTO `gameobject_addon` (`guid`, `parent_rotation0`, `parent_rotation1`, `parent_rotation2`, `parent_rotation3`, `invisibilityType`, `invisibilityValue`, `WorldEffectID`) VALUES (49512, 0, 0, 0.0649414, 0.997889, 8, 1000, 0);
