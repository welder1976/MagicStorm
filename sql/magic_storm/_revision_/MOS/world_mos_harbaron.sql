...
DELETE FROM `creature` WHERE `id` IN (98989, 98761, 100839);
DELETE FROM `creature` WHERE `guid` = 1006529;
...
DELETE FROM `creature_text` WHERE `entry` = @HARBARON;
