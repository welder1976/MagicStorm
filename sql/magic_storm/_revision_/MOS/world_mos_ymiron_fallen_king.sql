...
-- Arise, Fallen
DELETE FROM `spell_dbc_override` WHERE `spell` = 193566;
INSERT INTO `spell_dbc_override` VALUES (193566, 43, 0, 0, 0, '', 698272);
...
DELETE FROM `creature_text` WHERE `entry` = @YMIRON;
